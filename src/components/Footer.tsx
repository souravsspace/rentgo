    ...
    <footer className="relative w-full bg-black text-white py-[3rem]">
      <div className="flex justify-between items-center px-[8rem]">
        ...
        <section className="grid gap-4">
          ...
          <Typography variant="h2">+1 808 203 4565</Typography>
          <Typography variant="h5">youremail@example.com</Typography>
      ...
      <div className="mx-[5rem]">
        <div className="mt-12 border-t  border-blue-gray-50 py-4">
          <Typography
            variant="small"
            className="mb-4 font-normal text-white md:mb-0 px-12"
          >
