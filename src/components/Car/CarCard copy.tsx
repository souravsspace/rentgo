...
export function CarsCard() {
  ...
  const cardChildWidth = cardChild.current?.offsetWidth;
  console.log(cardChildWidth)

  const [rightCard, setRightCard] = useState(0);

  const handleRight = (): void => {
    if (width !== rightCard) return setRightCard((curr) => curr + 375 + 30);
    return;
  };
            ...
            <div key={index} className="grid mb-20 gap-8">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-1 items-center">
                  ...
                  <div
                    onClick={handleRight}
                    className="bg-gray-200 hover:bg-black hover:text-white text-gray-600 cursor-pointer px-2 py-1 rounded"
                  >
