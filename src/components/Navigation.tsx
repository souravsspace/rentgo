...
export function Navigation() {
  ...
  return (
    <Navbar
      shadow={false}
      className="sticky top-0 mx-auto w-screen py-2 px-4 lg:px-8 z-50"
    >
      <div className="mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className="hidden md:block">
          <ul className="mb-4 mt-2 flex flex-col gap-2 md:mb-0 md:mt-0 md:flex-row md:items-center lg:gap-6">
